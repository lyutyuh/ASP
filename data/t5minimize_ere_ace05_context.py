...
# Usage:
# python t5minimize_ere_ace05_context.py ./ace05/ ./ace05/
...
def minimize_partition(
    ...
    with open(input_path, "r") as input_file:
        ...
        for ins_id, instance in enumerate(instances):
            ...
            if "".join(tokens).lower() == "".join(tokens): # no capitalization
...
if __name__ == "__main__":
    ...
    print("stats:", stats)
    # ace05: {4: 1391, 0: 580, 6: 732, 7: 1464, 9: 426, 10: 621, 2: 620, 1: 539, 5: 265, 3: 118, 8: 314})
